    ...
    <div className="min-h-screen wood-background">
      ...
      <div className="bg-amber-700 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center space-x-6">
          <h2 className="text-xl font-bold text-amber-100">YsUp Bulletin Board</h2>
          <span className="text-amber-200">Community Events & Announcements</span>
        </div>
      ...
      <div className="p-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            {/* Premium Flyer Section */}
            <div className="lg:col-span-1">
              <div className="bg-yellow-400 border-4 border-yellow-600 rounded-lg p-4 shadow-2xl transform rotate-1">
                <div className="bg-red-600 text-white text-center py-2 rounded mb-4">
                  <span className="font-bold">PREMIUM SPONSOR</span>
                </div>
                <div
                ...
                >
                  ...
                  <div className="mt-2 text-center">
                    <h3 className="font-bold text-gray-800">{premiumFlyer.title}</h3>
            ...
            <div className="lg:col-span-3">
              <div
                className="relative w-full h-[800px] rounded-lg shadow-2xl overflow-hidden"
                style={{
                  background: `
              ...
              >
                ...
                <div className="absolute top-4 left-4 w-4 h-4 bg-red-500 rounded-full shadow-lg"></div>
                <div className="absolute top-4 right-4 w-4 h-4 bg-blue-500 rounded-full shadow-lg"></div>
                <div className="absolute bottom-4 left-4 w-4 h-4 bg-green-500 rounded-full shadow-lg"></div>
                <div className="absolute bottom-4 right-4 w-4 h-4 bg-yellow-500 rounded-full shadow-lg"></div>
                ...
                {flyers.map((flyer) => (
                  ...
                  >
                    ...
                    <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 z-10">
                      <Pin className="w-6 h-6 text-red-600 drop-shadow-lg" />
                    </div>
          ...
          <div className="relative max-w-4xl max-h-full">
            ...
            <div className="bg-white rounded-lg shadow-2xl overflow-hidden">
              ...
              <div className="bg-gray-100 p-4 flex items-center justify-between">
                <h3 className="text-xl font-bold text-gray-800">{selectedFlyer.title}</h3>
                <div className="flex items-center space-x-4">
                  <span className="text-sm text-gray-600">Showing: {showingBack ? "Back" : "Front"}</span>
                  <button
                    onClick={toggleSide}
          ...
          <div className="bg-white rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="bg-green-600 text-white p-4 rounded-t-lg">
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold">Post Your Ad - $5</h2>
                <button
            ...
            <form onSubmit={handleAdSubmit} className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    ...
                    {adFormData.frontImage && (
                      <p className="mt-2 text-sm text-green-600">{adFormData.frontImage.name}</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    ...
                    {adFormData.backImage && <p className="mt-2 text-sm text-green-600">{adFormData.backImage.name}</p>}
                  </div>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <h4 className="font-medium text-yellow-800 mb-2">Ad Guidelines:</h4>
              ...
              <button
                type="submit"
                className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-md font-medium transition-colors flex items-center justify-center space-x-2"
              >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-2xl max-w-md w-full">
            <div className="bg-blue-600 text-white p-4 rounded-t-lg">
              <h2 className="text-xl font-bold">Payment - $5.00</h2>
            </div>
            ...
            <div className="p-6 space-y-4">
              <div className="text-center">
                ...
                <p className="text-gray-600">Your ad: "{adFormData.title}"</p>
              </div>
              ...
              <div className="flex space-x-4">
                <button
                  ...
                  className="flex-1 bg-gray-500 hover:bg-gray-600 text-white py-3 rounded transition-colors"
                >
                  Cancel
                </button>
                <button

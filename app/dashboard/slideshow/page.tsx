        ...
        <div className="flex-1 rounded-xl overflow-hidden" style={{ border: "2px solid #0f3460", background: "#111" }}>
          {selectedDoc ? (
            <div className="h-full flex flex-col">
              ...
              <iframe src={selectedDoc.google_preview_url || selectedDoc.google_url?.replace(/\/edit.*$/, '/embed?start=false&loop=false')} className="flex-1 w-full min-h-[500px]" sandbox="allow-same-origin allow-scripts allow-popups allow-forms" />
            </div>
          ) : (
